...
Grille = 7               # Taille de la grille en nombre de cellules (8x8)
CELL_SIZE =50              # Taille de chaque cellule en pixels (60x60)
Marge = 3                # Espace entre les cellules en pixels
HEADER_HEIGHT = 50          # Hauteur de l'espace pour le score et l'heure
...
Image_direction =r"C:\Users\frede\OneDrive\Bureau\huete\Match IT\icon"         # Chemin vers le dossier contenant les images des bonbons
